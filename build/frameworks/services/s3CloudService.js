...
const s3Service = () => {
    ...
    const uploadAndGetUrl = (file) => __awaiter(void 0, void 0, void 0, function* () {
        const key = randomImageName();
        const params = {
            Bucket: config_1.default.AWS_BUCKET_NAME,
            Key: key,
    ...
    const getCloudFrontUrl = (fileKey) => __awaiter(void 0, void 0, void 0, function* () {
        const getDistributionParams = {
            Id: config_1.default.CLOUDFRONT_DISTRIBUTION_ID,
        };
        const command = new client_cloudfront_1.GetDistributionCommand(getDistributionParams);
        const { Distribution } = yield cloudFront.send(command);
        const cloudFrontDomain = Distribution === null || Distribution === void 0 ? void 0 : Distribution.DomainName;
